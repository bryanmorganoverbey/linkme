...
export default function MiniDrawer() {
  ...
  const drawerContent = (
    <React.Fragment>
      ...
      <Divider />
      <List sx={{ paddingBottom: { xs: 0, sm: "8px" } }}>
        {["Home", "Stuff", "Things"].map((text, index) => (
      ...
      >
        {["Bookmark", "Help", "Settings", "UserName"].map((text, index) => (
          <ListItem key={text} disablePadding sx={{ display: "block" }}>
            <ListItemButton
              sx={{
                minHeight: 48,
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Drawer
        ...
        sx={{
          ...
          border: { xs: "1px solid rgba(0, 0, 0, 0.12)", sm: "none" },
        }}
      >
        {drawerContent}
      </Drawer>
